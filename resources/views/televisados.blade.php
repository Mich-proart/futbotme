<x-layouts.app title="PARTIDOS DE FÚTBOL TELEVISADOS" meta-description="PARTIDOS DE FÚTBOL TELEVISADOS page">
    ...
    <section class="header_cat p-4 my-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                  <li><a class="dropdown-item active" href="#">Movistar</a></li>
        ...
        <p class="fs-000">Del Jueves 20 de abril al Lunes 25 de abril</p>
    </section>
    {{-- HOY --}}
    <div>
        ...
        <div id="" class="PartidosEnDirecto bg-white p-lg-4 p-3 mb-2">
            ...
            <div
                class="mx-0 partido_alineado my-2 my-2">
                <div class="local">
                ...
                <div class="mx-0 partido_alineado my-2marcador px-lg-4 px-3">
