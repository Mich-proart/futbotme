        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade " id="pills-jornada" role="tabpanel" aria-labelledby="pills-jornada-tab">
                ...
                <div class="jornadas_categorias mt-3 mb-5" id="jornadas_categorias">
                    ...
                    $HoraLimpia = substr($horabd, 0, -3); */
                    // Elimina los tres últimos caracteres :00
                    ?>
                    <div id="" class="PartidosFuturos bg-white p-lg-4 p-3 mb-2">
                        <div class="d-flex aling-items-center justify-content-between partido_futuro">
                            <div class="col d-flex aling-items-center ">
                                ...
                                <div>
                                    <span
                                        class="mx-4 hora minitos_partidos d-inline-block fw-semibold px-3 bg-gray-hora text-white">18:00</span>
                                </div>
                        ...
                        <div class="mx-0 partido_alineado my-2">
                            ...
                            <div class="marcador">
                                <span class="goles-local color-red">0 </span>
                                <span class="fs-01 color-red">-</span>
                                <span class="goles-visitante color-red"> 1 </span>
                            </div>
