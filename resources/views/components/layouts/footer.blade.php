<footer>
    <div class="footer-class border-top-green-second border-bottom-green-second py-5">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="content-logo">
                        ...
                        <p class="mb-0 mt-5 color-gray-contrast fs-00 w-25 remove-mobile">Copyright 1999-2023 Futbolme.com<br>Todos derechos reservados.</p>        
                    </div>
                </div>
                <div class="col-6">
                    <div class="d-flex align-items-center justify-content-end pb-4">
                        <span class="btn-flotante-arriba">
                    ...
                    <div class="row">
                        <div class="col-2 remove-desktop"></div>
                        <div class="col-10 col-lg-3">
                            <p><a href="" class="enlace-unstyle color-black">FAQ</a></p>
                            <p><a href="" class="enlace-unstyle color-black">Publicidad</a></p>
                            <p><a href="" class="enlace-unstyle color-black">Contacto</a></p>
                            <p><a href="" class="enlace-unstyle color-black">Livescore</a></p>
                            <p class="remove-desktop"><a href="" class="enlace-unstyle color-black">Golaverage</a></p>
                        </div>
                        <div class="col-12 col-lg-3 remove-mobile">
                            <p><a href="" class="enlace-unstyle color-black">Golaverage</a></p>
                            <p><a href="" class="enlace-unstyle color-black">Condiciones de uso </a></p>
                            <p><a href="" class="enlace-unstyle color-black">Política de cookies y privacidad</a></p>                                                
                        </div>
                    </div>                                
                </div>
            </div>

            <div class="row mt-2 mb-2 remove-desktop">
                <div class="col-12">
