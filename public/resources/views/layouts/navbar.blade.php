                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('assets_admin/images/users/avatar-4.jpg') }}"
                                                class="img-fluid rounded-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin-panel/') }}" role="button" aria-haspopup="true"
                            aria-expanded="false">
                            Directos
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin-panel/torneos/') }}" role="button"
                            aria-haspopup="true" aria-expanded="false">
                            Torneos
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin-panel/federaciones/') }}" role="button"
                            aria-haspopup="true" aria-expanded="false">
                            Federaciones
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin-panel/clubes/') }}" role="button"
                            aria-haspopup="true" aria-expanded="false">
                            Clubes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin-panel/jugadores') }}" role="button"
                            aria-haspopup="true" aria-expanded="false">
                            Jugadores
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin-panel/admin-disenho-menu/') }}" role="button"
                            aria-haspopup="true" aria-expanded="false">
                            Diseñar Menu
                        </a>
                    </li>
                    ...
                    {{-- <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#"
                            ...
                            aria-haspopup="true" aria-expanded="false">
                            <i class="uil-dashboard me-1"></i>Dashboards <div class="arrow-down">
                            </div>
                        </a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-crm">
                                    ...
                                    <a href="crm-orders-list.html" class="dropdown-item">Orders
                                        List</a>
                                    <a href="crm-clients.html" class="dropdown-item">Clients</a>
                                    <a href="crm-management.html"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-email">
                                    ...
                                    <a href="apps-email-read.html" class="dropdown-item">Read
                                        Email</a>
                                </div>
                            </div>
                            <div class="dropdown">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-tasks">
                                    ...
                                    <a href="apps-tasks-details.html"
                                        class="dropdown-item">Details</a>
                                    <a href="apps-kanban.html" class="dropdown-item">Kanban
                                        Board</a>
                                </div>
                            </div>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                    ...
                                    <a href="pages-register-2.html" class="dropdown-item">Register
                                        2</a>
                                    <a href="pages-logout.html" class="dropdown-item">Logout</a>
                                    <a href="pages-logout-2.html" class="dropdown-item">Logout
                                        2</a>
                                    ...
                                    <a href="pages-lock-screen.html" class="dropdown-item">Lock
                                        Screen</a>
                                    <a href="pages-lock-screen-2.html" class="dropdown-item">Lock
                                        Screen 2</a>
                                    <a href="pages-confirm-mail.html"
                                        class="dropdown-item">Confirm Mail</a>
                                    <a href="pages-confirm-mail-2.html"
                                        class="dropdown-item">Confirm Mail 2</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-error">
                                    ...
                                    <a href="pages-404-alt.html" class="dropdown-item">Error
                                        404-alt</a>
                                    <a href="pages-500.html" class="dropdown-item">Error 500</a>
                                </div>
                            </div>
                            <a href="pages-starter.html" class="dropdown-item">Starter Page</a>
                            <a href="pages-preloader.html" class="dropdown-item">With
                                Preloader</a>
                    ...
                    {{-- <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#"
                            ...
                            aria-haspopup="true" aria-expanded="false">
                            <i class="uil-package me-1"></i>Components <div class="arrow-down">
                            </div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-ui-kit">
                                    <a href="ui-accordions.html"
                                        class="dropdown-item">Accordions</a>
                                    ...
                                    <a href="ui-breadcrumb.html"
                                        class="dropdown-item">Breadcrumb</a>
                                    <a href="ui-buttons.html" class="dropdown-item">Buttons</a>
                                    <a href="ui-cards.html" class="dropdown-item">Cards</a>
                                    <a href="ui-carousel.html" class="dropdown-item">Carousel</a>
                                    <a href="ui-dropdowns.html"
                                        class="dropdown-item">Dropdowns</a>
                                    <a href="ui-embed-video.html" class="dropdown-item">Embed
                                        Video</a>
                                    <a href="ui-grid.html" class="dropdown-item">Grid</a>
                                    <a href="ui-list-group.html" class="dropdown-item">List
                                        Group</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-ui-kit2">
                                    ...
                                    <a href="ui-placeholders.html"
                                        class="dropdown-item">Placeholders</a>
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                    id="topnav-extended-ui" role="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-extended-ui">
                                    <a href="extended-dragula.html"
                                        class="dropdown-item">Dragula</a>
                                    <a href="extended-range-slider.html"
                                        class="dropdown-item">Range Slider</a>
                                    <a href="extended-ratings.html"
                                        class="dropdown-item">Ratings</a>
                                    <a href="extended-scrollbar.html"
                                        class="dropdown-item">Scrollbar</a>
                                    <a href="extended-scrollspy.html"
                                        class="dropdown-item">Scrollspy</a>
                                    <a href="extended-treeview.html"
                                        class="dropdown-item">Treeview</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none"
                                            href="#" id="topnav-apex-charts" role="button"
                                            data-bs-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">
                                    ...
                                    <a href="charts-chartjs.html"
                                        class="dropdown-item">Chartjs</a>
                                    <a href="charts-brite.html"
                                        class="dropdown-item">Britecharts</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-forms">
                                    ...
                                    <a href="form-validation.html"
                                        class="dropdown-item">Validation</a>
                                    <a href="form-wizard.html" class="dropdown-item">Wizard</a>
                                    <a href="form-fileuploads.html" class="dropdown-item">File
                                        Uploads</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    ...
                                    <a href="icons-mdi.html" class="dropdown-item">Material
                                        Design</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-maps">
                                    <a href="maps-google.html" class="dropdown-item">Google
                                        Maps</a>
                                    <a href="maps-vector.html" class="dropdown-item">Vector
                                        Maps</a>
                                </div>
                            </div>
                        </div>
